...
public class Mandelbrot extends FractalGenerator
{
    ...
    /**
     * Метод позволяет генератору фракталов указать,
    ...
    /**
     * Метод реализует итерационную функцию  Для фрактала Mandelbrot.
    ...
    public int numIterations(double x, double y)
    {
         ...
         * которую мы отображаем. Повторяется пока Z^2 > 4 или достигнуто максимальное число итераций.
         */
